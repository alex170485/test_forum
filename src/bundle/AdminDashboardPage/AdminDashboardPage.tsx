...
export const AdminDashboardPage = () => {
  const [dashboardItemType, setDashboardItemType] = useState<DashboardSideMenuItemType>(
    DASHBOARD_SIDE_MENU_ITEM_TYPE.USERS
  );
  ...
  return (
    <Wrapper>
      <Box position='relative'>
        <SideBarMenuWrapper>
          <SideBarMenuItem onClick={() => changeDashboards(DASHBOARD_SIDE_MENU_ITEM_TYPE.USERS)}>
            Пользователи
          </SideBarMenuItem>
          <SideBarMenuItem onClick={() => changeDashboards(DASHBOARD_SIDE_MENU_ITEM_TYPE.FORUMS)}>
            Все форумы
          </SideBarMenuItem>
        </SideBarMenuWrapper>
      </Box>
